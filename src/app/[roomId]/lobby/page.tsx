...
const Lobby = ({ params }: { params: { roomId: string } }) => {
  ...
  return (
    <main className="flex h-screen flex-col items-center bg-[url('/images/Untitled.jpeg')] justify-center text-slate-100">
      <div className="flex flex-col bg-black p-11 filter-none rounded-lg items-center justify-center gap-4 w-[26.25rem]">
        ...
        <div className="flex items-center w-full">
          ...
          >
            ...
            <Image
              ...
              className="w-6 h-6 ml-1 text-gray-800"
            />
          </button>
        </div>
      </div>
